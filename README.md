...
[![Dataset](https://img.shields.io/badge/Dataset-NFVessel-blue.svg)](#download)
[![Paper](https://img.shields.io/badge/Paper-FRA--YOLO-red.svg)](#associated-paper)
...
> NFVessel is introduced and evaluated in the above work as a task-specific benchmark for ship detection in complex nearshore environments.
